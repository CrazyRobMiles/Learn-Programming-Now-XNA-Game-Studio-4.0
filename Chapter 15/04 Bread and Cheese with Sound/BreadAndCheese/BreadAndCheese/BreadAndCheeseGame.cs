...
namespace BreadAndCheese
{
    ...
    public class DeadlySprite : MovingSprite
    {
            ...
            inMinDisplayY, inMaxDisplayY, initialX, initialY)
        {
            ...
            // Create the playable instance of the sound and make it loop
    ...
    public class KillerSprite : MovingSprite
    {
        ...
        public KillerSprite(
            ...
            : base(inSpriteTexture, widthFactor, ticksToCrossScreen,
                inMinDisplayX, inMaxDisplayX,
                inMinDisplayY, inMaxDisplayY,
                0, 0)  // set the initial position to 0,0 for now
        {
            initialX = rand.Next((int)minDisplayX, (int)(maxDisplayX - spriteRectangle.Width));
            initialY = rand.Next((int)minDisplayY, (int)(maxDisplayY - spriteRectangle.Height));
        ...
        protected override void LoadContent()
        {
            ...
            for (int i = 0; i < 100; i++)
            {
                ...
                Tangerine = new KillerSprite(
                    ...
                    1000,     // tangerine takes 200 ticks to cross the screen
                    minDisplayX,
                    maxDisplayX,
                    minDisplayY,
                    maxDisplayY,
