...
namespace BreadAndCheese
{
    ...
    public class MovingSprite : BaseSprite
    {
        ...
        /// <param name="initialX">start X position for the bread</param>
        /// <param name="initialY">start Y position for the bread</param>
    ...
    public class DeadlySprite : MovingSprite
    {
        ...
        public override void StartGame(float widthFactor, float ticksToCrossScreen,
            ...
            float inMaxDisplayY, float initialX, float initialY)
        {
            ...
            // Don't get a deadly sprite until the score reaches 200
            deadlyTriggerScore = 200;

            // Use the base behaviour to set up the rest of the pepper
            base.StartGame(widthFactor, ticksToCrossScreen,
                inMinDisplayX, inMaxDisplayX, inMinDisplayY,
                inMaxDisplayY, initialX, initialY);
        }
        ...
        public override void Update(BreadAndCheeseGame game)
        {
            ...
            if (y <= minDisplayY)
            {
                // sprite has hit the top of the screen.
                ySpeed = Math.Abs(ySpeed);
            }
    ...
    public class BreadAndCheeseGame : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            DeadlyPepper.LoadTexture(Content.Load<Texture2D>("Images/Pepper"));
