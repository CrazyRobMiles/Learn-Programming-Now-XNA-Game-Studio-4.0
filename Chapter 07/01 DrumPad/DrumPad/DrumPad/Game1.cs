...
namespace DrumPad
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        // Old gamepad state. XNA initializes this to all  
        // buttons not pressed. After the first call of Update
        // this holds the previous gamepad state
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            if (pad1.IsConnected)
            {
                // allow the game to exit when back is pressed
            ...
            // record the current gamepad state for the next
            // call of update
            oldpad1 = pad1;
